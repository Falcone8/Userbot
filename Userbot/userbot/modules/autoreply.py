...
async def cre(e):
  await e.edit("Userbot creato da: [SkammatoBene](t.me/SkammatoBene)")
...
async def comandi(e):
	await asyncio.wait([e.edit("[🔗Clicca qui](https://telegra.ph/SkammatoBene-Ubot-Personalizzato-03-10)")])
#BTC
